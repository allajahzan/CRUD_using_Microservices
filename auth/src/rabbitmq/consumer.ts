...
export const getUpdatedUserFromUserService = async (channel: amqp.Channel) => {
    ...
    const queue = 'USER_UPDATED_FROM_USER_SERVICE_TO_AUTH_SERVICE'
...
export const deletedUserFromAdminService = (channel: amqp.Channel) => {
    try {
        ...
        const queue = 'USER_DELETED_FROM_ADMIN_SERVICE_TO_AUTH_SERVICE'
...
export const getNewUserCreatedFromAdminService = (channel: amqp.Channel) => {
    try {
        ...
        const queue = 'USER_CREATE_FROM_ADMIN_SERVICE_TO_AUTH_SERVICE'
...
export const updatedUserFromAdminService = (channel: amqp.Channel) => {
    try {
        ...
        const queue = 'USER_UPDATED_FROM_ADMIN_SERVICE_TO_AUTH_SERVICE'
